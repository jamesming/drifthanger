...
<head>
		...
		queueComplete();
			...
			window.onload = function() {
				var settings = {
					...
					upload_url: "<?php echo  base_url();   ?>index.php/home/upload_photos_success?destination_item_id=<?php echo (isset($destination_item_id)?$destination_item_id:'');    ?>",
	...
	function queueComplete(){
							...
							destination_item_id:<?php echo (isset($destination_item_id)?$destination_item_id:'0');    ?>
							},function(data) {
										$('#error_div').html(data);
...
<div   style='display:none'   class=' container' >
			<form id='uploadForm' name='uploadForm' action='<?php echo  base_url();   ?>index.php/home/upload_photos_success?destination_item_id=<?php echo (isset($destination_item_id)?$destination_item_id:'');    ?>' 
			method='post' 
