...
<form id='uploadForm' 
	...
	<div id='input_container'    >
			<div  class='first float_left' >
				...
				if( isset($data['destination_items_image_id'])){
				echo $data['destination_items_image_id'];
				}else{
				echo '0';
				};
				
				    ?>">
				<input name="what_item" type="hidden" value="destination">
				<input name="destination_item_id" id="destination_item_id" type="hidden" value="<?php echo $data['destination_item_id']    ?>">
